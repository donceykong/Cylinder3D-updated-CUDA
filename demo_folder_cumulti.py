...
def build_dataset(dataset_config,
    ...
    CU_Multi_demo = get_pc_model_class('CU_Multi')

    demo_pt_dataset = CU_Multi_demo(data_dir, imageset=imageset,
...
def main(args):
    ...
    demo_label_dir = args.demo_label_folder if hasattr(args, 'demo_label_folder') and args.demo_label_folder else ''
    ...
    # Use get_SemKITTI_label_name since CU-Multi uses the same label mapping structure
    CU_Multi_label_name = get_SemKITTI_label_name(dataset_config["label_mapping"])
    ...
    inv_learning_map = cumultiyaml['learning_map_inv']
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/cumulti.yaml', help='Path to CU-Multi config file')
    parser.add_argument('--demo-folder', type=str, default='/media/donceykong/donceys_data_ssd/datasets/CU_MULTI/data', help='path to the folder containing demo lidar scans', required=False)
    parser.add_argument('--save-folder', type=str, default='/media/donceykong/donceys_data_ssd/datasets/CU_MULTI/data/main_campus/robot1/Cylinder3D_predictions', help='path to save your result', required=False)
    parser.add_argument('--demo-label-folder', type=str, default='/media/donceykong/donceys_data_ssd/datasets/CU_MULTI/data/main_campus/robot1/lidar_labels', help='path to the folder containing demo labels', required=False)
